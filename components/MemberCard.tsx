  ...
  return (
    <Link href={`/member/${member.id}`}>
      <div className="cosmic-card p-8 h-full cursor-pointer group">
        {/* 프로필 이미지 영역 */}
        <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-4xl font-black text-black">
        ...
        {/* 김찬주 개인 웹사이트 링크 */}
        <div className={`text-center mb-6 ${isKimChanJoo ? '' : 'invisible h-0'}`}>
        ...
        {/* 김찬주 카카오톡 버튼 */}
        <div className={`mt-6 text-center ${isKimChanJoo ? '' : 'invisible h-0'}`}>
          <button
